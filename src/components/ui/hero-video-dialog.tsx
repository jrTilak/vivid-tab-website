...
import AnimatedBorderTrail from "../animated/animated-border-trail";
      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[99] flex items-center justify-center bg-black/50 backdrop-blur-md h-screen w-screen"
          >
            <motion.div
              {...selectedAnimation}
